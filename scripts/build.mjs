...
const portraitSource = join(root, 'youngdahl.jpg');
...
cpSync(portraitSource, join(output, 'images', 'youngdahl.jpg'));
...
write(join(output, 'about', 'index.html'), layout('About', `<div class="about-layout"><section><p class="eyebrow">About</p>${renderPageMarkdown(readFileSync(aboutSource, 'utf8'))}</section><figure class="portrait"><img src="${route('images/youngdahl.jpg')}" width="241" height="320" alt="Portrait of Young-Dahl Song."><figcaption>Professor Young-Dahl Song</figcaption></figure></div>`));
